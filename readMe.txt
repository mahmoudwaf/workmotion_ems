...
Introduction :This code provide backend functionality APIs to implement Employee Management Business
Prerequisite:
The following list must be deployed to run the service:
-Java 11 or higher
-Docker
-git
